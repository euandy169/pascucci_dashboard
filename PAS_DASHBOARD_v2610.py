...
@st.cache_data(show_spinner=False)
def compute_market_trends(corpus):
...
@st.cache_data(show_spinner=False)
def compute_pairing_network(corpus):
...
@st.cache_data(show_spinner=False)
def compute_emergent_terms(corpus):
...
market_trends = compute_market_trends(market_corpus)
market_es = compute_market_es(market_corpus)
pair_net = compute_pairing_network(market_corpus)
emergent_df = compute_emergent_terms(market_corpus)
